...
{
    /// <inheritdoc />
    public partial class AddBookingDomainModel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartUtc = table.Column<DateTimeOffset>(type: "datetimeoffset(0)", precision: 0, nullable: false),
                    EndUtc = table.Column<DateTimeOffset>(type: "datetimeoffset(0)", precision: 0, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Bookings_EndUtc_After_StartUtc", "[EndUtc] > [StartUtc]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TimeSlots_EndUtc_After_StartUtc", "[EndUtc] > [StartUtc]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UX_BookingTimeSlots_TimeSlotId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeSlots_MeetingRoomId_StartUtc",
                table: "TimeSlots",
                columns: new[] { "MeetingRoomId", "StartUtc" },
                unique: true);
        }
